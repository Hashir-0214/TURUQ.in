      ...
      {articles.map((article, index) => {
        ...
        return (
          <article
            ...
            className="w-full flex flex-row items-center gap-2 sm:gap-6 lg:gap-10 border border-black rounded-xl p-2 md:p-4 hover:shadow-lg transition-all duration-300 bg-transparent"
            data-aos="fade-up"
