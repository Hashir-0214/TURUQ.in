...
export async function POST(req) {
    ...
    try {
        ...
        return NextResponse.json({ message: 'Error creating user: Internal Server Error' }, { status: 500 });
    }
}
...
export async function PUT(req) {
    ...
    try {
        ...
        return NextResponse.json({ message: 'Error updating user: Internal Server Error' }, { status: 500 });
    }
}
...
export async function DELETE(req) {
    ...
    try {
        ...
        return NextResponse.json({ message: 'Error deleting user: Internal Server Error' }, { status: 500 });
    }
}